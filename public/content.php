...
<div id="main">
 ...
 <?php
  ...
  // Check if the submited variable exist in the $_POST array and it's value 
  ...
  elseif (isset($_POST["category"]) && 
          ($_POST["category"] === "Road" || $_POST["category"] === "Mountain" || 
           $_POST["category"] === "Hybrid" || $_POST["category"] === "Cruiser" || 
           $_POST["category"] === "City" || $_POST["category"] === "BMX")) 
  {
    // echo $_POST["category"];
    $sort = "category";
    $category = "";
...
// Sort the data in the database and receive it 
switch($sort) {
  case "brand":
...
?>
      ...
      <?php else : ?>
        ...
        <tr>
          ...
          <td class="transform-color-case"><?php echo h($bike->get_content_color()); ?></td>
