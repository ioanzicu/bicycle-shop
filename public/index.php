...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner carousel slide" data-ride="carousel">
        <div class="carousel-item active" data-interval="5000">
            <img class="d-block w-100 img-fluid" src="/bicycle-shop/public/images/slider/b1.png" alt="First slide">
        ...
        <div class="carousel-item" data-interval="5000">
            <img class="d-block w-100 img-fluid" src="/bicycle-shop/public/images/slider/b2.png" alt="Second slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item" data-interval="5000">
            <img class="d-block w-100 img-fluid" src="/bicycle-shop/public/images/slider/b3.png" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
                <h1>Well Equipped</h1>
        ...
        <div class="carousel-item" data-interval="5000">
            <img class="d-block w-100 img-fluid" src="/bicycle-shop/public/images/slider/b4.png" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item" data-interval="5000">
            <img class="d-block w-100 img-fluid" src="/bicycle-shop/public/images/slider/b5.png" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
