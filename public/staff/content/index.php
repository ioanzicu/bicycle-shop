...
<div id="content">
  <div class="bicycles listing">
    ...
    <div class="actions">
      <a class="action" href="<?php echo url_for('/staff/content/new.php'); ?>">Add Bicycle</a>
    </div>
      ...
      <?php foreach($bicycles as $bicycle) { ?>
        <tr>
          ...
          <td><a class="action" href="<?php echo url_for('/staff/content/show.php?id=' . h(u($bicycle->get_content_id()))); ?>">View</a></td>
          <td><a class="action" href="<?php echo url_for('/staff/content/edit.php?id=' . h(u($bicycle->get_content_id()))); ?>">Edit</a></td>
          <td><a class="action" href="<?php echo url_for('/staff/content/delete.php?id=' . h(u($bicycle->get_content_id()))); ?>">Delete</a></td>
    	  </tr>
      <?php } ?>
  	</table>
