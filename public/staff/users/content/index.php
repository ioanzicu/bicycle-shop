      ...
      <?php foreach($bicycles as $bicycle) { ?>
        <tr>
          ...
          <td><?php echo h($bicycle->get_content_author()); ?></td>
            <td><a class="action" href="<?php echo url_for('/staff/users/content/show.php?id=' . h(u($bicycle->get_content_id()))); ?>">View</a></td>
          ...
          if($bicycle->get_content_author() == $cookie->get_username()) { ?>
            ...
            <td><a class="action" href="<?php echo url_for('/staff/users/content/edit.php?id=' . h(u($bicycle->get_content_id()))); ?>">Edit</a></td>
            <td><a class="action" href="<?php echo url_for('/staff/users/content/delete.php?id=' . h(u($bicycle->get_content_id()))); ?>">Delete</a></td>
