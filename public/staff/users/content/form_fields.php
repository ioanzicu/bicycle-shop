...
<dl>
    <dt>Price</dt>
    <dd>$ <input type="text" name="bicycle[price]" size="18" value="<?php echo h($bicycle->get_content_price()); ?>" />
    </dd>
</dl>
...
<dl>
  ...
  ?>
    <dt>Author</dt>
    <dd><input type="text" name="bicycle[author]" size="18" value="<?php echo h($bicycle->get_content_author()) ?>"
            readonly /></dd>
</dl>

<dl>
    <dt>Description</dt>
    <dd><textarea name="bicycle[description]" rows="5"
            cols="50"><?php echo h($bicycle->get_content_decription()); ?></textarea></dd>
</dl>