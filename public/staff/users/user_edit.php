...
<div id="content">
  ...
  <a class="back-link" href="<?php echo url_for('/staff/users/user_account.php'); ?>">&laquo; Back to Account</a>
  ...
  <div class="user edit">
    ...
    <form action="<?php echo url_for('./staff/users/user_edit.php?id=' . h(u($id))); ?>" method="post">
