    ...
    <div class="actions">
      ...
      <?php foreach($users as $user) { ?>
        <tr>
          ...
          <td><a class="action" href="<?php echo url_for('/staff/users/show.php?id=' . h(u($user->get_user_id()))); ?>">View</a></td>
          <td><a class="action" href="<?php echo url_for('/staff/users/edit.php?id=' . h(u($user->get_user_id()))); ?>">Edit</a></td>
          <td><a class="action" href="<?php echo url_for('/staff/users/delete.php?id=' . h(u($user->get_user_id()))); ?>">Delete</a></td>
    	  </tr>
      <?php } ?>
  	</table>
