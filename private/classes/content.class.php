...
class Content extends DatabaseObject
{
    ...
    public static function sort_by_brand()
    {
    ...
    public static function sort_by_model()
    {
    ...
    public static function sort_by_year()
    {
    ...
    public static function sort_by_category($category)
    {
        $sql =
            "SELECT * FROM " .
            static::$table_name .
    ...
    public static function sort_by_gender($gender)
    {
        $sql =
            "SELECT * FROM " .
            static::$table_name .
    ...
    public static function sort_by_color()
    {
